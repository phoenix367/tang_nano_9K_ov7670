...
//Created Time: 2024-01-13 04:51:25
...
create_generated_clock -name lcd_clock -source [get_ports {sys_clk}] -master_clock base -divide_by 16 -multiply_by 5 [get_ports {LCD_CLK}]
