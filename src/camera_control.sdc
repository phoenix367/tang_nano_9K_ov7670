...
//Created Time: 2023-11-20 13:19:28
...
create_generated_clock -name lcd_clock -source [get_ports {video_clk_i}] -master_clock video_clock -multiply_by 1 [get_ports {LCD_CLK}]
