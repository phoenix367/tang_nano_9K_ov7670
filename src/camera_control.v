...
`include "build_config.vh"      // generated by CMake: SERV_CONTROL flag + firmware path
...
// register-backend handshake into the SCCB bridge (cam_bridge side)
wire        be_req, be_we, be_ready;
wire [15:0] be_addr, be_wdata, be_rdata;
// the Modbus host master side of the handshake (modbus_rtu_slave drives these)
...
`else
// Default build: the Modbus host is the sole master (direct wiring, unchanged).
assign be_req       = mb_be_req;
assign be_we        = mb_be_we;
assign be_addr      = mb_be_addr;
assign be_wdata     = mb_be_wdata;
assign mb_be_ready  = be_ready;
assign mb_be_rdata  = be_rdata;
`endif
...
modbus_rtu_slave #(
    ...
    .be_we(mb_be_we),
    .be_addr(mb_be_addr),
    .be_wdata(mb_be_wdata),
    .be_ready(mb_be_ready),
